...
#include <vfh_local_planner/VFHPlannerConfig.h>
...
namespace vfh_local_planner {
  ...
  class VFHPlannerROS : public nav_core::BaseLocalPlanner {
    public:
       ...
       */
	VFHPlannerROS() : costmap_ros_(NULL), tf_(NULL), initialized_(false),odom_helper_("odom"), setup_(false) {}
     ...
     bool computeVelocityCommands(geometry_msgs::Twist& cmd_vel);
       ...
       */
      void reconfigureCB(VFHPlannerConfig &config, uint32_t level);
	...
	void odomCallback (const nav_msgs::Odometry::ConstPtr& odom_msg);
      ...
      dynamic_reconfigure::Server<VFHPlannerConfig> *dsrv_;
      vfh_local_planner::VFHPlannerConfig default_config_;
};
